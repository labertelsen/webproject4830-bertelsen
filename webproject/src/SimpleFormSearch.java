...
public class SimpleFormSearch extends HttpServlet {
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         while (rs.next()) {
            int id = rs.getInt("id");
            String userName = rs.getString("TITLE").trim();
            String email = rs.getString("AUTHOR").trim();
            String phone = rs.getString("LENGTH").trim();

            if (keyword.isEmpty() || userName.contains(keyword)) {
               out.println("ID: " + id + ", ");
               out.println("Title: " + userName + ", ");
               out.println("Author: " + email + ", ");
               out.println("Length: " + phone + "<br>");
            }
         }
